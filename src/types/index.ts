...
export const CatalogItemSchema = z.object({
    ...
    title: z.string(),
    duration_minutes: z.number().nullable().optional().transform(val => val || 60),
    price: z.string().nullable().optional().transform(val => val || 'Por cotizar')
});
...
export const LeadProfileSchema = z.object({
    ...
    current_step: z.string().nullable().optional().transform(val => val || 'SALUDO'),
    summary: z.string().nullable().optional().transform(val => val || 'Nuevo Cliente'),
