        ...
        },
        {
            ...
            parameters: {
                ...
                properties: {
                    ...
                    duration_minutes: {
                        type: 'INTEGER',
                        description: 'Duración en minutos del servicio que desea el cliente (obtenido del catálogo).',
                        nullable: true,
                    },
                },
                required: ['date'],
        ...
        },
        {
            ...
            parameters: {
                ...
                properties: {
                    ...
                    pet_name: {
                        type: 'STRING',
                        description: "Nombre EXACTO de la mascota a agendar. NUNCA agrupes múltiples nombres (ej. usa 'Ñapa', NUNCA 'Ñapa y Embale').",
                    },
        ...
        },
        {
            ...
            parameters: {
                ...
                properties: {
                    ...
                    start_time: {
                        type: 'STRING',
                        description: 'Hora exacta de la cita a cancelar (formato HH:MM). OBLIGATORIO para no cancelar la cita equivocada de ese día.',
                    },
                },
        ...
        },
        {
            ...
            parameters: {
                ...
                properties: {
                    reason: {
                        type: 'STRING',
                        description: 'Breve razón o motivo de por qué de la transferencia (ej: cliente enojado, caso complejo, pidió humano explícitamente).',
                    },
                },
                required: ['reason'],
            },
        },
        {
            ...
            parameters: {
                ...
                properties: {
                    pet_name: {
                        type: 'STRING',
                        description: "Nombre de la mascota (ej. 'Baly', 'Luna'). Úsalo siempre para distinguir entre diferentes mascotas del mismo dueño.",
                    },
                    category: {
                        type: 'STRING',
