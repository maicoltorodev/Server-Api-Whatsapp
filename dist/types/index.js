...
exports.CatalogItemSchema = zod_1.z.object({
    ...
    duration_minutes: zod_1.z.number().nullable().optional().transform(val => val || 60),
    price: zod_1.z.string().nullable().optional().transform(val => val || 'Por cotizar')
});
// ==========================================
...
exports.LeadProfileSchema = zod_1.z.object({
    ...
    current_step: zod_1.z.string().nullable().optional().transform(val => val || 'SALUDO'),
    summary: zod_1.z.string().nullable().optional().transform(val => val || 'Nuevo Cliente'),
